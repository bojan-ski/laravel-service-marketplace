...
class ClientUserController extends Controller
{
    ...
    public function clientOpenProjects(): View
    {
        ...
        $projects = $this->user->openProjects()->latest()->paginate(12);
    ...
    public function clientInProgressProjects(): View
    {
        ...
        $projects = $this->user->inProgressProjects()->latest()->paginate(12);
    ...
    public function clientCompletedProjects(): View
    {
        ...
        $projects = $this->user->completedProjects()->latest()->paginate(12);
    ...
    public function clientCancelledProjects(): View
    {
        ...
        $projects = $this->user->cancelledProjects()->latest()->paginate(12);
